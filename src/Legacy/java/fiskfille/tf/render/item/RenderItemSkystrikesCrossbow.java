...
import fiskfille.tf.model.item.ModelSkystrikesCrossbow;
...
public class RenderItemSkystrikesCrossbow implements IItemRenderer
{
	...
	{
		Minecraft.getMinecraft().renderEngine.bindTexture(new ResourceLocation(MainClass.modid, "textures/models/weapons/skystrikes_crossbow.png"));
