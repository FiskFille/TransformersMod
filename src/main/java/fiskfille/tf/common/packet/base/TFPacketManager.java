...
public class TFPacketManager
{
    ...
    public static void registerPackets()
    {
        networkWrapper = NetworkRegistry.INSTANCE
                .newSimpleChannel("transformersMod");

        registerPacket(PacketHandleTransformation.Handler.class,
                PacketHandleTransformation.class);
        registerPacket(PacketHandleStealthTransformation.Handler.class,
                PacketHandleStealthTransformation.class);
        registerPacket(PacketSyncStates.Handler.class, PacketSyncStates.class);
        registerPacket(PacketTransformersAction.Handler.class,
                PacketTransformersAction.class);
        registerPacket(PacketCloudtrapJetpack.Handler.class,
                PacketCloudtrapJetpack.class);
        registerPacket(PacketBroadcastState.Handler.class,
                PacketBroadcastState.class);
        registerPacket(PacketVehicleNitro.Handler.class,
                PacketVehicleNitro.class);
        registerPacket(PacketVurpSniperShoot.Handler.class,
                PacketVurpSniperShoot.class);
    ...
    {
        networkWrapper.registerMessage(messageHandler, requestMessageType,
