...
public class ItemPurgesKatana extends ItemSword
{
            ...
            EntityPlayer player, int time)
    {
                ...
                && TFHelper.isPlayerPurge(player))
        {
            ...
            Vec3 vec3 = TFMotionManager.getFrontCoords(player,
                    player.onGround ? d : d * 0.75D, true);
    ...
    public Multimap getItemAttributeModifiers()
    {
        ...
        multimap.removeAll(SharedMonsterAttributes.attackDamage
                .getAttributeUnlocalizedName());
        multimap.put(SharedMonsterAttributes.attackDamage
                .getAttributeUnlocalizedName(), new AttributeModifier(
                field_111210_e, "Weapon modifier", 8.0D, 0));
        return multimap;
    }
}