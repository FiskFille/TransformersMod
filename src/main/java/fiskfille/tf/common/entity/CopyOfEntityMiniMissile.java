...
public class CopyOfEntityMiniMissile extends EntityArrow implements IProjectile
{
    ...
    public CopyOfEntityMiniMissile(World world)
    {
        super(world);
    ...
    public CopyOfEntityMiniMissile(World world, double x, double y, double z)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
    ...
    public CopyOfEntityMiniMissile(World world, EntityLivingBase shooter, EntityLivingBase p_i1755_3_, float p_i1755_4_, float p_i1755_5_)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
    ...
    public CopyOfEntityMiniMissile(World world, EntityLivingBase shooter, float strength, boolean allowMissileExplosions)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = shooter;
