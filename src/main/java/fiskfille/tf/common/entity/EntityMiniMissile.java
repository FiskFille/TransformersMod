...
public class EntityMiniMissile extends EntityThrowable implements IEntityAdditionalSpawnData
{
    ...
    public EntityMiniMissile(World world, EntityLivingBase thrower, boolean missileExplosions)
    {
        super(world, thrower);
    ...
    public EntityMiniMissile(World world, boolean missileExplosions)
    {
        super(world);
        this.missileExplosions = missileExplosions;
    }
    ...
    protected void onImpact(MovingObjectPosition mop)
    {
        ...
        if(hit)
        {
            worldObj.createExplosion(getThrower(), x, y, z, 2, missileExplosions);
