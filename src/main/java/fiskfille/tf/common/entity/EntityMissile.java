...
public class EntityMissile extends EntityArrow implements IProjectile
{
    ...
    public EntityMissile(World world, EntityLivingBase shooter,
    ...
    public EntityMissile(World world, EntityLivingBase shooter, float strength,
            boolean allowMissileExplosions, boolean stealth)
    {
        super(world);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = shooter;
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            for (int i = 0; i < 40; ++i)
            {
                ...
                // worldObj.spawnParticle("flame", posX + (rand.nextFloat() /
                // 4), posY + (rand.nextFloat() / 4), posZ + (rand.nextFloat() /
                // 4), 0, 0, 0);
            }
            ...
            vec3 = Vec3.createVectorHelper(this.posX + this.motionX, this.posY
