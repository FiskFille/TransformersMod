...
public class TFEntities
{
    public static void registerEntities()
    {
        ...
        registerEntity(EntityTransformiumSeed.class, "tf_transformium_seed",
                20, 10, true);
        registerEntity(EntityFlamethrowerFire.class, "tf_flamethrower_fire",
                20, 10, true);
        registerEntity(EntityBassCharge.class, "tf_bass_charge", 20, 10, true);
    }

    private static void registerEntity(Class<? extends Entity> entityClass,
            String name, int trackingRange, int updateFrequency,
            boolean sendVelocityUpdates)
    {
        ...
        EntityRegistry.registerModEntity(entityClass, name, id,
                TransformersMod.instance, trackingRange, updateFrequency,
                sendVelocityUpdates);
    }
}
