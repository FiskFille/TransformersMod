...
public class RecipesDisplayItems implements IRecipe
{
    ...
    public ItemStack getCraftingResult(InventoryCrafting inventoryCrafting)
    {
        ...
        if (head != null && chest != null && legs != null && feet != null)
        {
            ...
            for (Transformer transformer : TransformersAPI.getTransformers())
            {
                ...
                if (headItem == helmet && chestItem == chestplate
                        && legsItem == leggings && feetItem == boots)
                {
    ...
    public void setNBTData(ItemStack head, ItemStack chest, ItemStack legs,
            ItemStack feet, ItemStack itemstack)
    {
