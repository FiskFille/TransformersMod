...
public class TFAchievements
{
    ...
    public static Achievement transform = new Achievement("achievement.tf.transform", "tf.transform", 4, -2, TFSubItems.wheel[1], transformium).registerStat();
    ...
    public static Achievement tracks = new Achievement("achievement.tf.tracks", "tf.tracks", -5, -3, TFSubItems.tank_track[1], null).registerStat();
