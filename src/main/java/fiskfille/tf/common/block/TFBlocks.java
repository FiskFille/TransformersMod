...
public class TFBlocks
{
    ...
    {
        transformiumOre = new BlockBasic(Material.rock)
                .setHarvestLvl("pickaxe", 2).setHardness(10.0F)
                .setResistance(1000.0F);
        displayPillar = new BlockDisplayPillar().setHardness(0.5F)
                .setResistance(1.0F);
        energonCrystal = new BlockEnergonCrystal().setHarvestLvl("pickaxe", 1)
                .setStepSound(Block.soundTypeGlass).setHardness(6.0F)
                .setResistance(10.0F).setLightLevel(0.75F);
        energonCube = new BlockEnergonCube().setHarvestLvl("pickaxe", 1)
                .setStepSound(Block.soundTypeGlass).setHardness(6.0F)
                .setResistance(10.0F).setLightLevel(0.75F);
        transformiumStone = new BlockTransformiumStone()
                .setHarvestLvl("pickaxe", 2).setHardness(2.5F)
                .setResistance(10.0F);
        ...
        TFBlockRegistry.registerTileEntity(displayPillar, "Display Pillar",
                TileEntityDisplayPillar.class);
        TFBlockRegistry.registerTileEntity(energonCrystal, "Energon Crystal",
        ...
        TFBlockRegistry.registerTileEntity(transformiumSeed,
                "Transformium Seed", TileEntityTransformiumSeed.class);
    }
}