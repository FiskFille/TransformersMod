...
{
	// TODO: Find out what's wrong with the CLoudtrap's vehicle render.
	...
	public ModelCloudtrapVehicle()
	{
		...
		vehicleBody = new ModelRenderer(this, 1000, 1000);
		vehicleBody.addBox(-3F, -1F, -2F, 6, 2, 12);
		vehicleBody.setRotationPoint(0F, 22.5F, -4.2F);
		vehicleBody.setTextureSize(64, 128);
		vehicleBody.mirror = true;
		setRotateAngle(vehicleBody, 0F, 0F, 0F);
