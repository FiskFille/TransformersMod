...
public class ModelSkystrike extends ModelChildBase.Biped
{
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if (entity instanceof EntityPlayer)
		{
			...
			int timer = TFPlayerData.getTransformationTimer(player);
			...
			else
			{
				...
				setRotation(backPiece, -0.4712389F - ((10 - t) * 0.2F), 0F, 0F);
				setRotation(chest, -((10 - t) * 0.3F), 0F, 0F);
				bipedHead.rotationPointY = (10 - t) * 0.8F;
				
				float armPosX = -5F + ((10 - t) * 0.3F);
				float armPosY = (10 - t) * 0.4F;
				bipedRightArm.setRotationPoint(armPosX, armPosY, 0.0F);
				bipedLeftArm.setRotationPoint(-armPosX, armPosY, 0.0F);
				
				if (t < 10)
				{
					bipedRightArm.rotateAngleX = (10 - t) * 0.15F;
					bipedLeftArm.rotateAngleX = (10 - t) * 0.15F;
					bipedRightLeg.rotateAngleX = (10 - t) * 0.2F;
					bipedLeftLeg.rotateAngleX = (10 - t) * 0.2F;
