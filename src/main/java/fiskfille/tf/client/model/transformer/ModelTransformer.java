...
<<<<<<< HEAD:src/main/java/fiskfille/tf/model/transformer/ModelChildBase.java
import fiskfille.tf.data.TFDataManager;
import fiskfille.tf.data.TFPlayerData;
import fiskfille.tf.item.TFItems;
=======
import fiskfille.tf.client.model.player.ModelPlayerTF;
>>>>>>> parent of 52b2aa7... Revert "fix it, gegs":src/main/java/fiskfille/tf/client/model/transformer/ModelTransformer.java
