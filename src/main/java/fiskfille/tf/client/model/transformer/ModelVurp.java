...
public class ModelVurp extends MowzieModelBase
{
    ...
    public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
    {
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            rotateTo(armbaseL1, vehiclearmbaseL1, f);
            rotateTo(armbaseR1, vehiclearmbaseR1, f);
            rotateTo(backplate1, vehiclebackplate1, f);
            rotateTo(backplate2, vehiclebackplate2, f);
            rotateTo(frontL1, vehiclefrontL1, f);
            rotateTo(frontL2, vehiclefrontL2, f);
            rotateTo(frontR1, vehiclefrontR1, f);
            rotateTo(frontR2, vehiclefrontR2, f);
            rotateTo(hood1, vehiclehood1, f);
            rotateTo(hood2, vehiclehood2, f);
            rotateTo(hood3, vehiclehood3, f);
            rotateTo(hood4, vehiclehood4, f);
            rotateTo(kneeL1, vehiclekneeL2, f);
            rotateTo(kneeR1, vehicleKneeR1, f);
            rotateTo(lowerArmL, vehicleLowerarmL1, f);
            rotateTo(lowerarmL2, vehicleLowerarmL2, f);
            rotateTo(lowerArmR, vehiclelowerarmR1, f);
            rotateTo(lowerarmR2, vehiclelowerarmR2, f);
            rotateTo(lowerLegL, vehiclelowerlegL1, f);
            rotateTo(lowerlegL4, vehiclelowerlegL4, f);
            rotateTo(lowerlegL5, vehiclelowerlegL5, f);
            rotateTo(lowerlegL7, vehiclelowerlegL7, f);
            rotateTo(lowerLegR, vehicleLowerlegR1, f);
            rotateTo(lowerlegR4, vehicleLowerlegR4, f);
            rotateTo(lowerlegR5, vehicleLowerlegR5, f);
            rotateTo(lowerlegR7, vehiclelowerlegR7, f);
            rotateTo(upperLegL, vehicleUpperlegL1, f);
            rotateTo(upperlegL2, vehicleupperlegL2, f);
            rotateTo(upperLegR, vehicleUpperlegR1, f);
            rotateTo(upperlegR2, vehicleUpperlegR2, f);
            rotateTo(torsobase, vehicletorsobase, f);
            rotateTo(torsoconnector1, vehicleTorsoconnector1, f);
            rotateTo(waist1, vehicleWaist1, f);
            rotateTo(waist2, vehicleWaist2, f);
            rotateTo(shoulderR1, vehicleshoulderL1, f);
