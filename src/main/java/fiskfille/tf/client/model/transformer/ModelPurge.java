...
public class ModelPurge extends MowzieModelBase
{
    ...
    public ModelPurge()
    {
        ...
        this.setRotation(tread1, 0.17453292519943295F, -0.0F,
        ...
        this.setRotation(lowerLegPanel2, 0.008726646259971648F,
        ...
        this.setRotation(helmetLeft, 0.07438152130324906F,
                -0.15803570099691838F, -0.4422247463038985F);
        ...
        this.setRotation(lowerArm1, -0.19198621771937624F,
        ...
        this.setRotation(upperLegPanel2, 0.008726646259971648F,
                -0.17453292519943295F, 0.0F);
        ...
        this.setRotation(tread2, 0.17453292519943295F, -0.0F,
                0.08726646259971647F);
        ...
        this.setRotation(foot1, 0.3490658503988659F, -0.0F,
        ...
        this.setRotation(foot2, 0.3490658503988659F, -0.0F,
        ...
        this.setRotation(lowerLegPanel1, 0.008726646259971648F,
                0.17453292519943295F, 0.0F);
        ...
        this.setRotation(lowerArm2, -0.19198621771937624F,
                0.13962634015954636F, 0.13962634015954636F);
        ...
        this.setRotation(upperLegPanel1, 0.008726646259971648F,
                0.17453292519943295F, 0.0F);
        ...
        this.setRotation(helmetRight, 0.07438152130324906F,
                0.15803570099691838F, 0.4422247463038985F);
        ...
        // parts = new MowzieModelRenderer[]{upperLegL, lowerLeg2, foot2,
        // footCylinder2, lowerLegPanel2, upperLegPanel2, upperLegR, lowerLeg1,
        // foot1, footCylinder1, lowerLegPanel1, upperLegPanel1, waist, stomach,
        // hipSlab1, hipSlab2, chest, backKibble, chestSlab1, chestSlab2,
        // tread1, tread2, turret, gun, turretFront, turretSights, turretRear,
        // missileLauncher, hipPanel1, hipPanel2, upperArmL, shoulderPad2,
        // lowerArm2, lowerArmPanel2, upperArmR, shoulderPad1, lowerArm1,
        // lowerArmPanel1, head, helmetRight, helmetLeft, helmetTop, helmetBack,
        // horn1, horn2, centerHorn};
        setInitPose();
    }
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            if (fullSuit)
            {
                if (this.onGround > -9990.0F)
                {
                    ...
                    stomach.rotateAngleY += 20 * (hitTick) * (hitTick - 0.4)
                            * (Math.pow(hitTick, 0.3F) - max);
                    chest.rotateAngleY += 20 * (hitTick) * (hitTick - 0.4)
                            * (Math.pow(hitTick, 0.3F) - max);
                    head.rotateAngleY += -40 * (hitTick) * (hitTick - 0.4)
                            * (Math.pow(hitTick, 0.3F) - max);
                    upperArmR.rotateAngleZ += -2 * (hitTick)
                            * (Math.pow(hitTick, 5) - max);
                    upperArmR.rotateAngleX += 40 * (hitTick) * (hitTick - 0.4)
                            * (Math.pow(hitTick, 0.3F) - max);
                    lowerArm1.rotateAngleX += 50 * (hitTick) * (hitTick - 0.5)
                            * (hitTick - 0.5) * (hitTick - max);
                    upperArmL.rotateAngleX -= 40 * (hitTick) * (hitTick - 0.4)
                            * (Math.pow(hitTick, 0.3F) - max);
                    lowerArm2.rotateAngleX += 25 * (hitTick)
                            * (Math.pow(hitTick, 0.1) - max);
                }
                ...
                if (playerOnGround || player.capabilities.isFlying)
                {
                    ...
                    walk(chest, 1F * globalSpeed, 0.05F * globalDegree, false,
                            1, 0.15F * par2 * backwardInverter, par1, par2);
                    swing(chest, 0.5F * globalSpeed, 0.6F * globalDegree, true,
                            0, 0, par1, par2);
                    ...
                    walk(upperLegL, 0.5F * globalSpeed, 1.2F * globalDegree,
                            true, 0, 0, par1, par2);
                    walk(lowerLeg1, 0.5F * globalSpeed, 1.2F * globalDegree,
                            false, -2.2F * backwardInverter, 0.6F, par1, par2);
                    walk(lowerLeg2, 0.5F * globalSpeed, 1.2F * globalDegree,
                    ...
                    walk(upperArmL, 0.5F * globalSpeed, 0.5F * globalDegree,
                            ...
                            par2);
                    walk(lowerArm1, 0.5F * globalSpeed, 0.5F * globalDegree,
                            true, -1F * backwardInverter, -0.5F * par2, par1,
                            par2);
                    walk(lowerArm2, 0.5F * globalSpeed, 0.5F * globalDegree,
                            false, -1F * backwardInverter, -0.5F * par2, par1,
                            par2);

                    flap(hipPanel1, 1F * globalSpeed, 0.2F * globalDegree,
                            false, -1, 0, par1, par2);
                    flap(hipPanel2, 1F * globalSpeed, 0.2F * globalDegree,
                            true, -1, 0, par1, par2);
                    walk(gun, 1F * globalSpeed, -0.3F * globalDegree, false,
                            -1, 0, par1, par2);
                ...
                // If not on ground
                {
                    ...
                    walk(lowerLeg1, 0.5F * globalSpeed, 0.2F * globalDegree
                            * downwardPose, false, -2.2F * backwardInverter,
                            0F, par1, par2);
                    walk(lowerLeg2, 0.5F * globalSpeed, 0.2F * globalDegree
            ...
            // If not fully suited
            {
                ...
                this.lowerArm1.rotateAngleX += (MathHelper.cos(par1 * 0.6662F
                ...
                if (this.onGround > -9990.0F)
                {
                    ...
                    this.upperArmR.rotationPointZ = MathHelper
                            .sin(this.waist.rotateAngleY) * 4.5F;
                    this.upperArmR.rotationPointX = -MathHelper
                            .cos(this.waist.rotateAngleY) * 4.5F;
            ...
            float transformProgress = (float) (20 - TFDataManager
                    .getTransformationTimer(player)) / 20;
            float transformProgressSin = MathHelper
                    .sin(1.57079632679F * transformProgress)
                    * MathHelper.sin(1.57079632679F * transformProgress);
            ...
            if (TFDataManager.getTransformationTimer(player) == 0)
            {
                ...
                this.vehicleTurret.rotateAngleY = par4
                        / (180F / (float) Math.PI);

                /*
                 * float xRotation = par5 / (180F / (float)Math.PI);
                 * 
                 * bipedHead.offsetY = 256F; bipedBody.offsetY = 256F;
                 * bipedRightArm.offsetY = 256F; bipedLeftArm.offsetY = 256F;
                 * bipedRightLeg.offsetY = 256F; bipedLeftLeg.offsetY = 256F;
                 */
            ...
            {
                /*
                 * int t = TFDataManager.getTransformationTimer(player); float f
                 * = (float)(20 - t) / 2; float armPosY = (((float)(20 - t) /
                 * 2)) * 2.0F; float xRotation = (float)((t * (Math.PI / 40)) -
                 * Math.PI / 2);
                 * 
                 * bipedBody.rotateAngleY = (float)((t * (Math.PI / 20)) -
                 * Math.PI); bipedBody.rotationPointX = armPosY / 9;
                 ...
                 * 
                 * if (t < 20) { bipedRightLeg.rotationPointY = f * 0.2F + 12;
                 ...
                 * 
                 * bipedHead.offsetY = 0F; bipedBody.offsetY = 0F;
                 * bipedRightArm.offsetY = 0F; bipedLeftArm.offsetY = 0F;
                 * bipedRightLeg.offsetY = 0F; bipedLeftLeg.offsetY = 0F;
                 */
