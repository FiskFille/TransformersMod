...
public class ModelPurge extends MowzieModelBase
{
	...
	public ModelPurge()
	{
        ...
        this.leg2 = new MowzieModelRenderer(this, 0, 16);
        ...
        this.leg1 = new MowzieModelRenderer(this, 0, 16);
        ...
        parts = new MowzieModelRenderer[]{leg2, foot2, footCylinder2, lowerLegPanel2, upperLegPanel2, leg1, foot1, footCylinder1, lowerLegPanel1, upperLegPanel1, waist, stomach, hipSlab1, hipSlab2, chest, backKibble, chestSlab1, chestSlab2, tread1, tread2, turret, gun, turretFront, turretSights, turretRear, missileLauncher, hipPanel1, hipPanel2, upperArm2, shoulderPad2, lowerArm2, lowerArmPanel2, upperArm1, shoulderPad1, lowerArm1, lowerArmPanel1, head, helmetRight, helmetLeft, helmetTop, helmetBack, horn1, horn2, centerHorn};
	    setInitPose();
    }
