...
public class ModelSubwoofer extends ModelChildBase.Biped
{
	...
	MowzieModelRenderer helmetPiece1;
	MowzieModelRenderer helmetPiece2;
	MowzieModelRenderer helmetEar1;
	MowzieModelRenderer helmetEar2;
	MowzieModelRenderer helmet;
	MowzieModelRenderer waist;
	MowzieModelRenderer chestPanel1;
	MowzieModelRenderer chestPanel2;
	MowzieModelRenderer chestPanel3;
	MowzieModelRenderer chestPanel4;
	MowzieModelRenderer chestPanel5;
	MowzieModelRenderer hipSlab1;
	MowzieModelRenderer hipSlab2;
	MowzieModelRenderer bumper1;
	MowzieModelRenderer bumper2;
	MowzieModelRenderer upperBumper1;
	MowzieModelRenderer middleBumper1;
	MowzieModelRenderer upperBumper2;
	MowzieModelRenderer middleBumper2;
	MowzieModelRenderer chest;
	MowzieModelRenderer stomach;
	MowzieModelRenderer leg1;
	MowzieModelRenderer upperLegSlab1;
	...
	MowzieModelRenderer upperLegSlab2;
	...
	MowzieModelRenderer shoulder2;
	MowzieModelRenderer frontWheel2;

	MowzieModelRenderer vehicleBase;
	...
	MowzieModelRenderer vehicleUpperBumper1;
	MowzieModelRenderer vehicleUpperBumper2;
	MowzieModelRenderer vehicleMiddleBumper;
	MowzieModelRenderer vehicleTrunk;
	...
	public MowzieModelRenderer stealthForceUpperBumper1;
	public MowzieModelRenderer stealthForceUpperBumper2;
	public MowzieModelRenderer stealthForceMiddleBumper;
	public MowzieModelRenderer stealthForceTrunk;
	...
	public MowzieModelRenderer stealthForceSideGun1;
	public MowzieModelRenderer stealthForceBackWheel2;
	public MowzieModelRenderer stealthForceSideGun2;
	...
	public ModelSubwoofer()
	{
		...
		helmetPiece1 = new MowzieModelRenderer(this, 6, 6);
		...
		helmetPiece2 = new MowzieModelRenderer(this, 6, 6);
		...
		helmetEar1 = new MowzieModelRenderer(this, 0, 6);
		...
		helmetEar2 = new MowzieModelRenderer(this, 0, 6);
		...
		helmet = new MowzieModelRenderer(this, 12, 0);
		...
		chestPanel2 = new MowzieModelRenderer(this, 16, 24);
		...
		chestPanel3 = new MowzieModelRenderer(this, 22, 20);
		...
		chestPanel4 = new MowzieModelRenderer(this, 16, 20);
		...
		chestPanel5 = new MowzieModelRenderer(this, 11, 33);
		...
		hipSlab1 = new MowzieModelRenderer(this, 0, 45);
		...
		hipSlab2 = new MowzieModelRenderer(this, 0, 45);
		...
		bumper1 = new MowzieModelRenderer(this, 8, 42);
		...
		bumper2 = new MowzieModelRenderer(this, 8, 42);
		bumper2.mirror = true;
		...
		upperBumper1 = new MowzieModelRenderer(this, 8, 39);
		...
		middleBumper1 = new MowzieModelRenderer(this, 16, 35);
		...
		upperBumper2 = new MowzieModelRenderer(this, 8, 39);
		...
		middleBumper2 = new MowzieModelRenderer(this, 16, 35);
		...
		stomach = new MowzieModelRenderer(this, 0, 20);
		...
		leg1 = new MowzieModelRenderer(this, 28, 20);
		...
		upperLegSlab1 = new MowzieModelRenderer(this, 22, 34);
		...
		upperLegPanel1 = new MowzieModelRenderer(this, 20, 27);
		...
		lowerLegPanel1 = new MowzieModelRenderer(this, 0, 39);
		...
		foot1 = new MowzieModelRenderer(this, 0, 33);
		...
		backWheel1 = new MowzieModelRenderer(this, 44, 11);
		...
		leg2 = new MowzieModelRenderer(this, 28, 20);
		...
		upperLegSlab2 = new MowzieModelRenderer(this, 22, 34);
		...
		upperLegPanel2 = new MowzieModelRenderer(this, 20, 27);
		...
		lowerLegPanel2 = new MowzieModelRenderer(this, 0, 39);
		...
		foot2 = new MowzieModelRenderer(this, 0, 33);
		...
		backWheel2 = new MowzieModelRenderer(this, 44, 11);
		...
		upperArm1 = new MowzieModelRenderer(this, 24, 12);
		...
		lowerArm1 = new MowzieModelRenderer(this, 36, 11);
		...
		shoulder1 = new MowzieModelRenderer(this, 44, 15);
		...
		frontWheel1 = new MowzieModelRenderer(this, 44, 11);
		...
		upperArm2 = new MowzieModelRenderer(this, 24, 12);
		...
		lowerArm2 = new MowzieModelRenderer(this, 36, 11);
		...
		shoulder2 = new MowzieModelRenderer(this, 44, 15);
		...
		frontWheel2 = new MowzieModelRenderer(this, 44, 11);
		...
		vehicleBase = new MowzieModelRenderer(this, 0, 64);
		...
		vehicleRoof = new MowzieModelRenderer(this, 18, 83);
		...
		vehicleBackWindShield = new MowzieModelRenderer(this, 14, 86);
		...
		vehicleWindShield = new MowzieModelRenderer(this, 13, 78);
		...
		vehicleDoor1 = new MowzieModelRenderer(this, 24, 64);
		...
		vehicleDoor2 = new MowzieModelRenderer(this, 24, 64);
		...
		vehicleBumper1 = new MowzieModelRenderer(this, 0, 70);
		...
		vehicleBumper2 = new MowzieModelRenderer(this, 0, 70);
		...
		vehicleUpperBumper1 = new MowzieModelRenderer(this, 0, 68);
		...
		vehicleUpperBumper2 = new MowzieModelRenderer(this, 0, 68);
		...
		vehicleMiddleBumper = new MowzieModelRenderer(this, 6, 68);
		...
		vehicleTrunk = new MowzieModelRenderer(this, 0, 84);
		...
		vehicleHood = new MowzieModelRenderer(this, 0, 78);
		...
		this.stealthForceFrontWheelCover2 = new MowzieModelRenderer(this, 31, 68);
		...
		this.stealthForceTrunk = new MowzieModelRenderer(this, 0, 84);
		this.stealthForceTrunk.setRotationPoint(0.0F, -0.3F, 7.8F);
		this.stealthForceTrunk.addBox(-2.5F, -1.0F, 0.0F, 5, 1, 2, 0.0F);
		this.stealthForceUpperBumper1 = new MowzieModelRenderer(this, 0, 68);
		...
		this.stealthForceBackWheelCover2 = new MowzieModelRenderer(this, 24, 68);
		...
		this.stealthForceBumper1 = new MowzieModelRenderer(this, 0, 70);
		...
		this.stealthForceSideGun1 = new MowzieModelRenderer(this, 29, 64);
		this.stealthForceSideGun1.setRotationPoint(-0.4F, 0.0F, -4.0F);
		this.stealthForceSideGun1.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.stealthForceSideGun2 = new MowzieModelRenderer(this, 29, 64);
		...
		this.stealthForceHood = new MowzieModelRenderer(this, 0, 78);
		...
		this.stealthForceFrontWheelCover1 = new MowzieModelRenderer(this, 31, 68);
		...
		this.stealthForceBackWindShield = new MowzieModelRenderer(this, 14, 86);
		...
		this.stealthForceWindShield = new MowzieModelRenderer(this, 13, 78);
		...
		this.stealthForceBumper2 = new MowzieModelRenderer(this, 0, 70);
		...
		this.stealthForceUpperBumper2 = new MowzieModelRenderer(this, 0, 68);
		...
		this.stealthForceDoor1 = new MowzieModelRenderer(this, 24, 64);
		...
		this.stealthForceDoor2 = new MowzieModelRenderer(this, 24, 64);
		...
		this.stealthForceFrontGun = new MowzieModelRenderer(this, 29, 64);
		this.stealthForceFrontGun.setRotationPoint(0.0F, 0.5F, -2.0F);
		this.stealthForceFrontGun.addBox(-0.5F, -0.5F, -2.0F, 1, 1, 2, 0.0F);
		this.stealthForceBackWheelCover1 = new MowzieModelRenderer(this, 24, 68);
		...
		this.stealthForceRoof = new MowzieModelRenderer(this, 18, 83);
		this.stealthForceRoof.setRotationPoint(0.0F, -1.8F, 3.6F);
		this.stealthForceRoof.addBox(-2.5F, -0.5F, 0.0F, 5, 1, 2, 0.0F);
		this.stealthForceMiddleBumper = new MowzieModelRenderer(this, 6, 68);
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6, Entity entity)
	{
		...
		if (entity instanceof EntityPlayer)
		{
			...
			{
				for (MowzieModelRenderer modelRenderer : new MowzieModelRenderer[] {stealthForceBase, vehicleBase})
				{
