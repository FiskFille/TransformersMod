...
public class ModelSkystrike extends ModelChildBase.Biped
{
	...
	public MowzieModelRenderer FeedbaseL;
	...
	public MowzieModelRenderer upperamrR;
	...
	public ModelSkystrike()
	{
		...
		this.middlelegR.setRotationPoint(-1.6F, 3.5F, 0.9F);
		this.middlelegR.addBox(-1.0F, -0.1F, 0.0F, 2, 2, 4, 0.0F);
		this.setRotation(middlelegR, 0.09250245035569946F, 0.06981317007977318F, 0.0F);
		...
		this.lowertorso.setRotationPoint(0.0F, 5.9F, 2.4F);
		...
		this.middlelegL.setRotationPoint(1.4F, 3.5F, 0.9F);
		this.middlelegL.addBox(-1.0F, -0.1F, 0.0F, 2, 2, 4, 0.0F);
		this.setRotation(middlelegL, 0.09250245035569946F, -0.06981317007977318F, 0.0F);
		...
		this.upperlegR.setRotationPoint(0.0F, 0.5F, 1.0F);
		this.upperlegR.addBox(-3.0F, -0.5F, -1.5F, 3, 6, 3, 0.0F);
		...
		this.headbase.setRotationPoint(0.0F, -1.7F, -0.5F);
		this.headbase.addBox(-2.0F, -3.0F, -2.0F, 4, 4, 4, 0.0F);
		this.FeedbaseL = new MowzieModelRenderer(this, 62, 68);
		this.FeedbaseL.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.FeedbaseL.addBox(-1.2F, 1.0F, -1.8F, 3, 3, 3, 0.0F);
		this.setRotation(FeedbaseL, 0.33161255787892263F, 0.0F, 0.0F);
		...
		this.setRotation(wheelconnectorR, -0.24434609527920614F, 0.0F, 0.0F);
		...
		this.upperamrR = new MowzieModelRenderer(this, 46, 68);
		this.upperamrR.setRotationPoint(-2.5F, 0.6F, -0.5F);
		this.upperamrR.addBox(-1.0F, 0.0F, -1.0F, 2, 4, 2, 0.0F);
		this.setRotation(upperamrR, 0.017453292519943295F, -0.017453292519943295F, 0.05235987755982988F);
		...
		this.lowerlegL.setRotationPoint(0.0F, 0.0F, 4.0F);
		this.lowerlegL.addBox(-1.3F, -0.2F, -1.1F, 3, 7, 3, 0.0F);
		this.setRotation(lowerlegL, -0.07330382858376185F, 0.0F, 0.0F);
		...
		this.lowerchestM.addBox(-1.5F, 0.3F, -5.8F, 3, 2, 3, 0.0F);
		...
		this.LowerchestL.addBox(-2.0F, -0.7F, -5.8F, 2, 3, 3, 0.0F);
		this.setRotation(LowerchestL, -0.9948376736367678F, 0.0F, 0.0F);
		this.waist = new MowzieModelRenderer(this, 12, 53);
		this.waist.setRotationPoint(0.0F, 1.4F, -2.0F);
		this.waist.addBox(-3.0F, 0.0F, 0.0F, 6, 5, 4, 0.0F);
		...
		this.upperlegL.setRotationPoint(2.0F, 0.5F, 1.0F);
		this.upperlegL.addBox(0.0F, -0.5F, -1.5F, 3, 6, 3, 0.0F);
		...
		this.lowerlegR.setRotationPoint(0.0F, 0.0F, 4.0F);
		this.lowerlegR.addBox(-1.7F, -0.2F, -1.1F, 3, 7, 3, 0.0F);
		this.setRotation(lowerlegR, -0.07330382858376185F, 0.0F, 0.0F);
		...
		this.setRotation(wheelconnectorL, -0.24434609527920614F, 0.0F, 0.0F);
		...
		this.neck.setRotationPoint(0.0F, 0.0F, 2.5F);
		...
		this.feetbaseR.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.feetbaseR.addBox(-1.8F, 1.0F, -1.8F, 3, 3, 3, 0.0F);
		this.setRotation(feetbaseR, 0.33161255787892263F, 0.0F, 0.0F);
		...
		this.rearwaist.setRotationPoint(0.0F, -0.8F, 4.4F);
		this.rearwaist.addBox(-2.0F, 0.0F, -0.3F, 4, 6, 2, 0.0F);
		this.setRotation(rearwaist, -0.3804817769347638F, 0.0F, 0.0F);
		this.lowerchestR = new MowzieModelRenderer(this, 0, 90);
		this.lowerchestR.setRotationPoint(-4.0F, 7.0F, 3.0F);
		this.lowerchestR.addBox(0.0F, -0.7F, -5.8F, 2, 3, 3, 0.0F);
		...
		this.FeedbaseL.addChild(this.toeL2);
		this.lowerarmL1.addChild(this.lowerarmL3);
		this.FeedbaseL.addChild(this.feetpartL2);
		...
		this.upperamrR.addChild(this.lowerarmR1);
		...
		this.FeedbaseL.addChild(this.feetpartL1);
		...
		this.ShoulderR.addChild(this.upperamrR);
