...
public class TFModelRegistry
{
    ...
    public static void registerModel(Transformer transformer, Biped model,
            ModelVehicleBase vehicleModel)
    {
    ...
    {
        TFModelRegistry.registerModel(TransformerManager.transformerCloudtrap,
                new ModelCloudtrap(), new ModelCloudtrapVehicle());
        TFModelRegistry.registerModel(TransformerManager.transformerPurge,
                new ModelPurge(), new ModelPurgeVehicle());
        TFModelRegistry.registerModel(TransformerManager.transformerSkystrike,
                new ModelSkystrike(), new ModelSkystrikeVehicle());
        TFModelRegistry.registerModel(TransformerManager.transformerSubwoofer,
                new ModelSubwoofer(), new ModelSubwooferVehicle());
        TFModelRegistry.registerModel(TransformerManager.transformerVurp,
                new ModelVurp(), new ModelVurpVehicle());
    }
}
