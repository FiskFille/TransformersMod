...
public class ModelCloudtrap extends ModelChildBase.Biped
{
    ...
    public ModelCloudtrap()
    {
        ...
        setRotateAngle(headTopPiece2, 0.8377580409572781F,
                0.13962634015954636F, 0.2792526803190927F);
        ...
        setRotateAngle(lowerArmPanel2, -0.33161255787892263F, -0.0F,
        ...
        setRotateAngle(frontLegBeam1, 0.7330382858376184F, 0.0F,
        ...
        setRotateAngle(frontLegBeam2, 0.7330382858376184F, 0.0F,
                0.05235987755982988F);
        ...
        setRotateAngle(oxymenTube1, 0.45378560551852565F, -0.8726646259971648F,
                0.0F);
        ...
        setRotateAngle(lowerArm1, -0.33161255787892263F, -0.0F,
        ...
        setRotateAngle(upperLeg2, -0.40142572795869574F, 0.0F,
        ...
        setRotateAngle(outerWing1, 0.015707963267948967F, 0.0F,
                0.9075712110370513F);
        ...
        setRotateAngle(frontPiece2, -0.06981317007977318F, 3.141592653589793F,
                0.0F);
        ...
        setRotateAngle(jetEngine2, 0.7330382858376184F, 0.0F,
                0.13962634015954636F);
        ...
        setRotateAngle(legPanel2, 0.06981317007977318F, -0.17453292519943295F,
        ...
        setRotateAngle(outerWing2, 0.015707963267948967F, 0.0F,
                -0.9075712110370513F);
        ...
        setRotateAngle(oxygenTube2, 0.45378560551852565F, 0.8726646259971648F,
                0.0F);
        ...
        setRotateAngle(jetEngine1, 0.7330382858376184F, 0.0F,
                -0.13962634015954636F);
        ...
        setRotateAngle(lowerArm2, -0.33161255787892263F, -0.0F,
                0.06981317007977318F);
        ...
        setRotateAngle(upperWing2, 0.08726646259971647F, 0.0F,
        ...
        setRotateAngle(lowerArmPanel1, -0.33161255787892263F, -0.0F,
                -0.10471975511965977F);
        ...
        setRotateAngle(upperWing1, 0.08726646259971647F, 0.0F,
                0.20943951023931953F);
        ...
        setRotateAngle(torsoBlade2, -0.3141592653589793F, 0.0F,
                0.2792526803190927F);
        ...
        setRotateAngle(headTopPiece1, 0.8377580409572781F,
                -0.13962634015954636F, -0.2792526803190927F);
        ...
        setRotateAngle(torsoBlade1, -0.3141592653589793F, 0.0F,
                -0.2792526803190927F);
        ...
        setRotateAngle(backLegBeam2, 0.2617993877991494F, 0.0F,
                0.05235987755982988F);
        ...
        setRotateAngle(upperLeg1, -0.40142572795869574F, 0.0F,
                0.13962634015954636F);
        ...
        setRotateAngle(legPanel1, 0.06981317007977318F, 0.17453292519943295F,
                0.08726646259971647F);
            ...
            float par4, float par5, float par6, Entity entity)
    {
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            else
            {
                ...
                this.frontPiece2.rotateAngleX = -(pi / 20) * f * 2
                        - 0.06981317007977318F;
                this.frontPiece2.rotateAngleY = -3.141592653589793F - (pi / 10)
                        * f;
