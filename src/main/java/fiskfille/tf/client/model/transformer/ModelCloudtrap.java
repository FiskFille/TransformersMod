...
public class ModelCloudtrap extends ModelChildBase.Biped
{
	...
	MowzieModelRenderer vehicleMain;
	MowzieModelRenderer vehicleFrontPiece2;
	MowzieModelRenderer vehicleFrontPiece3;
	MowzieModelRenderer vehicleRightEngine;
	MowzieModelRenderer vehicleLeftEngine;
	MowzieModelRenderer vehicleRightFrontWing;
	MowzieModelRenderer vehicleLeftFrontWing;
	MowzieModelRenderer vehicleMiddleWing;
	MowzieModelRenderer vehicleRightWing;
	MowzieModelRenderer vehicleLeftWing;
	MowzieModelRenderer vehicleMiddlePiece;
	MowzieModelRenderer vehicleBackPiece;
	MowzieModelRenderer vehicleBackFin1;
	MowzieModelRenderer vehicleBackFin2;
	MowzieModelRenderer vehicleBackFin3;
	MowzieModelRenderer vehicleRightBackWing;
	MowzieModelRenderer vehicleLeftBackWing;
	MowzieModelRenderer vehicleCockpit;
	MowzieModelRenderer vehicleFrontPiece1;
	...
	public ModelCloudtrap()
	{
		...
		vehicleLeftFrontWing = new MowzieModelRenderer(this, 40, 116);
		...
		vehicleBackFin1 = new MowzieModelRenderer(this, 22, 76);
		...
		vehicleRightFrontWing = new MowzieModelRenderer(this, 40, 116);
		...
		vehicleRightWing = new MowzieModelRenderer(this, 40, 86);
		...
		vehicleLeftWing = new MowzieModelRenderer(this, 40, 86);
