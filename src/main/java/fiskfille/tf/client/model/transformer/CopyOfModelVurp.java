...
public class CopyOfModelVurp extends ModelChildBase.Biped
{
    ...
    public CopyOfModelVurp()
    {
        ...
        this.stealthForceBackWindShield.addBox(-2.5F, -0.5F, 0.0F, 5, 1, 3,
                0.0F);
        this.setRotation(stealthForceBackWindShield, -0.3839724354387525F,
                -0.0F, 0.0F);
        ...
        this.stealthForceBackWheelCover2.addBox(0.0F, -1.0F, -2.0F, 1, 2, 4,
                0.0F);
        ...
        this.setRotation(stealthForceWindShield, 0.45378560551852565F, -0.0F,
                0.0F);
        ...
        this.stealthForceBackWheelCover1.addBox(-1.0F, -1.0F, -2.0F, 1, 2, 4,
                0.0F);
        ...
        this.stealthForceFrontWheelCover2 = new MowzieModelRenderer(this, 28,
                68);
        this.stealthForceFrontWheelCover2.setRotationPoint(3.0F, 0.0F, 1.5F);
        this.stealthForceFrontWheelCover2.addBox(0.0F, -1.0F, -1.5F, 1, 2, 4,
                0.0F);
        ...
        this.stealthForceFrontWheelCover1 = new MowzieModelRenderer(this, 28,
                68);
        this.stealthForceFrontWheelCover1.setRotationPoint(-3.0F, 0.0F, 1.5F);
        this.stealthForceFrontWheelCover1.addBox(-1.0F, -1.0F, -1.5F, 1, 2, 4,
                0.0F);
        ...
        this.stealthForceFrontWheelCover2
                .addChild(this.stealthForceFrontWheel2);
        ...
        this.stealthForceFrontWheelCover1
                .addChild(this.stealthForceFrontWheel1);
            ...
            float par4, float par5, float par6, Entity entity)
    {
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            {
                for (MowzieModelRenderer modelRenderer : new MowzieModelRenderer[] {
                        stealthForceBase, vehicleBody })
                {
                    float f1 = this.bipedHead.rotateAngleY
                            - (this.bipedBody.rotateAngleY - this.bipedHead.rotateAngleY)
                            / 3;
                    if (modelRenderer.rotateAngleY < f1)
                    {
                        modelRenderer.rotateAngleY += 0.05F;
                    }
                    if (modelRenderer.rotateAngleY > f1)
                    {
                        modelRenderer.rotateAngleY -= 0.05F;
                ...
                else
                {
                    ...
                    stealthForceHood.rotateAngleX = -0.13962634015954636F
                            * (f / 10);
