...
import net.ilexiconn.llibrary.client.render.IEquippedItemsExtension;
...
public class PlayerModelOverride implements IModelExtension, IFirstPersonExtension, IArrowStuckExtension, IEquippedItemsExtension
{
    @Override
    ...
    @Override
    public void postRenderFirstPerson(EntityPlayer player, RenderPlayer renderPlayer, ModelBiped model)
    {
    }
    ...
    @Override
    public boolean preRenderFirstPerson(EntityPlayer player, RenderPlayer renderPlayer, ModelBiped modelBiped)
    {
    ...
    @Override
    public void postRenderArrowsStuckInEntity(EntityLivingBase entity, RenderPlayer renderPlayer, float arg1)
    {
    }
    
    @Override
    public boolean preRenderArrowsStuckInEntity(EntityLivingBase entity, RenderPlayer renderPlayer, float partialTicks)
    {
        GL11.glPushMatrix();
    ...
    @Override
    public void postRenderEquippedItems(AbstractClientPlayer arg0, RenderPlayer arg1, float arg2)
    {
        
    }
    
    @Override
    public boolean preRenderEquippedItems(AbstractClientPlayer player, RenderPlayer renderer, float partialTicks)
    {
        if (TFHelper.getTransformerFromArmor(player, 2) != null)
        {
            ...
            if (modelBipedMain != null)
            {
                ...
                net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.client.event.RenderPlayerEvent.Specials.Post(player, renderer, partialTicks));
            }
