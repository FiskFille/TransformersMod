...
public class ModelPlayerTF extends ModelChildBase.Biped
{
    ...
    public void render(Entity entity, float p_78088_2_, float p_78088_3_,
            float p_78088_4_, float p_78088_5_, float p_78088_6_, float f5)
    {
        TFModelHelper.modelBipedMain = this;

        this.setRotationAngles(p_78088_2_, p_78088_3_, p_78088_4_, p_78088_5_,
                p_78088_6_, f5, entity);
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            boolean wearingTransformerHelm = helm != null
                    && helm.getItem() instanceof ItemTransformerArmor;
            ItemStack chest = player.getCurrentArmor(2);
            boolean wearingTransformerChest = chest != null
                    && chest.getItem() instanceof ItemTransformerArmor;
            ItemStack pants = player.getCurrentArmor(1);
            boolean wearingTransformerPants = pants != null
                    && pants.getItem() instanceof ItemTransformerArmor;
