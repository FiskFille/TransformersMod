...
public class ModelTransformiumSeed extends ModelBase
{
    ...
    public void setRotation(ModelRenderer modelRenderer, float x, float y,
            float z)
    {
    ...
    public void setRotationAngles(EntityTransformiumSeed seed)
    {
        ...
        this.setRotation(wingA,
                (0.06981317007977318F * i + ((float) Math.PI / 2) * t), 0.0F,
                0.0F);
        this.setRotation(wingB, 0.0F, 0.0F,
                -(0.06981317007977318F * i + ((float) Math.PI / 2) * t));
        this.setRotation(wingC,
                -(0.06981317007977318F * i + ((float) Math.PI / 2) * t), 0.0F,
                0.0F);
        this.setRotation(wingD, 0.0F, 0.0F,
                (0.06981317007977318F * i + ((float) Math.PI / 2) * t));
