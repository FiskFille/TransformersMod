...
/**
 * ModelMissile - gegy1000 Created using Tabula 4.0.0
 */
public class ModelMissile extends ModelBase
{
    ...
    public ModelMissile()
    {
        ...
        this.setRotateAngle(BottomRight, 0.0F, -0.17453292519943295F,
                -0.7853981633974483F);
        ...
        this.setRotateAngle(TopRight, 0.17453292519943295F,
                -0.17453292519943295F, -0.7853981633974483F);
        ...
        this.setRotateAngle(BottomLeft, 0.0F, 0.17453292519943295F,
                0.7853981633974483F);
        ...
        this.setRotateAngle(TopLeft, 0.17453292519943295F,
                0.17453292519943295F, 0.7853981633974483F);
    }
    ...
    {
        GL11.glPushMatrix();
        GL11.glTranslatef(this.Nosecone2.offsetX, this.Nosecone2.offsetY,
                this.Nosecone2.offsetZ);
        GL11.glTranslatef(this.Nosecone2.rotationPointX * f5,
                this.Nosecone2.rotationPointY * f5,
                this.Nosecone2.rotationPointZ * f5);
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(this.BottomRight.offsetX, this.BottomRight.offsetY,
                this.BottomRight.offsetZ);
        GL11.glTranslatef(this.BottomRight.rotationPointX * f5,
                this.BottomRight.rotationPointY * f5,
                this.BottomRight.rotationPointZ * f5);
        ...
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        GL11.glTranslatef(this.TopRight.offsetX, this.TopRight.offsetY,
                this.TopRight.offsetZ);
        GL11.glTranslatef(this.TopRight.rotationPointX * f5,
                this.TopRight.rotationPointY * f5, this.TopRight.rotationPointZ
                        * f5);
        GL11.glScaled(0.5D, 0.5D, 0.5D);
        GL11.glTranslatef(-this.TopRight.offsetX, -this.TopRight.offsetY,
                -this.TopRight.offsetZ);
        GL11.glTranslatef(-this.TopRight.rotationPointX * f5,
                -this.TopRight.rotationPointY * f5,
                -this.TopRight.rotationPointZ * f5);
        this.TopRight.render(f5);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        GL11.glTranslatef(this.Nosecone1.offsetX, this.Nosecone1.offsetY,
                this.Nosecone1.offsetZ);
        GL11.glTranslatef(this.Nosecone1.rotationPointX * f5,
                this.Nosecone1.rotationPointY * f5,
                this.Nosecone1.rotationPointZ * f5);
        GL11.glScaled(0.6D, 0.6D, 0.6D);
        GL11.glTranslatef(-this.Nosecone1.offsetX, -this.Nosecone1.offsetY,
                -this.Nosecone1.offsetZ);
        GL11.glTranslatef(-this.Nosecone1.rotationPointX * f5,
        ...
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        GL11.glTranslatef(this.BottomLeft.offsetX, this.BottomLeft.offsetY,
                this.BottomLeft.offsetZ);
        GL11.glTranslatef(this.BottomLeft.rotationPointX * f5,
                this.BottomLeft.rotationPointY * f5,
                this.BottomLeft.rotationPointZ * f5);
        GL11.glScaled(0.5D, 0.5D, 0.5D);
        GL11.glTranslatef(-this.BottomLeft.offsetX, -this.BottomLeft.offsetY,
                -this.BottomLeft.offsetZ);
        GL11.glTranslatef(-this.BottomLeft.rotationPointX * f5,
        ...
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        GL11.glTranslatef(this.TopLeft.offsetX, this.TopLeft.offsetY,
                this.TopLeft.offsetZ);
        GL11.glTranslatef(this.TopLeft.rotationPointX * f5,
                this.TopLeft.rotationPointY * f5, this.TopLeft.rotationPointZ
                        * f5);
        GL11.glScaled(0.5D, 0.5D, 0.5D);
        GL11.glTranslatef(-this.TopLeft.offsetX, -this.TopLeft.offsetY,
                -this.TopLeft.offsetZ);
