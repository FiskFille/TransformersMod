...
public class ModelSkystrikesCrossbow extends ModelChildBase.Base
{
            ...
            float f3, float f4, float f5)
    {
        if (entity instanceof EntityPlayer)
        {
            ...
            {
                // boolean flag =
                // ItemSkystrikesCrossbow.blueMode.get(entity.getCommandSenderName())
                // != null ?
                // ItemSkystrikesCrossbow.blueMode.get(entity.getCommandSenderName())
                // : false;
                boolean flag = itemstack.hasTagCompound() ? itemstack
                        .getTagCompound().getBoolean("blueMode") : false;
                float pidb2 = pi / 2;
