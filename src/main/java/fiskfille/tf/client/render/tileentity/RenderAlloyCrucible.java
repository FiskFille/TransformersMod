...
public class RenderAlloyCrucible extends TileEntitySpecialRenderer
{
    ...
    public void render(TileEntityAlloyCrucible tile, double x, double y, double z, float partialTicks)
    {
        ...
        if (world != null)
        {
//            int metadata = world.getBlockMetadata(tile.xCoord, tile.yCoord, tile.zCoord);
            int metadata = tile.getBlockMetadata();
            
//            System.out.println(String.format("Metadata: %s, Rotation: %s, Front: %s, Top: %s", metadata, BlockAlloyCrucible.getRotation(metadata), BlockAlloyCrucible.getFlag(metadata, BlockAlloyCrucible.FLAG_FRONT), BlockAlloyCrucible.getFlag(metadata, BlockAlloyCrucible.FLAG_TOP)));
        }
