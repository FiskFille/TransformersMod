...
public class RenderCrystal extends TileEntitySpecialRenderer
{
    ...
    public void renderAModelAt(TileEntityCrystal tileentity, double d,
    ...
    public void adjustRotation(TileEntityCrystal tile, double d, double d1,
            double d2, float f)
    {
        int rot = tile.getWorldObj().getBlockMetadata(tile.xCoord, tile.yCoord,
                tile.zCoord);
        if (rot == 1)
        {
