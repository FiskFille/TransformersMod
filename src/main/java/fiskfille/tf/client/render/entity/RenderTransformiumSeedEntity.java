...
public class RenderTransformiumSeedEntity extends Render
{
    ...
    public void doRender(EntityTransformiumSeed seed, double x, double y,
    ...
    {
        return new ResourceLocation(TransformersMod.modid
                + ":textures/models/tiles/transformium_seed.png");
    }
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_,
            ...
            float p_76986_9_)
    {
        this.doRender((EntityTransformiumSeed) p_76986_1_, p_76986_2_,
