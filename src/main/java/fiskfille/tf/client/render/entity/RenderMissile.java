...
public class RenderMissile extends Render
{
     ...
     */
    public void doRender(EntityMissile missile, double x, double y, double z,
            float rotationYaw, float p_76986_9_)
    {
        this.bindEntityTexture(missile);
        GL11.glPushMatrix();
        GL11.glTranslatef((float) x, (float) y, (float) z);
        GL11.glRotatef(missile.prevRotationYaw
                + (missile.rotationYaw - missile.prevRotationYaw) * p_76986_9_
                - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(missile.prevRotationPitch
                + (missile.rotationPitch - missile.prevRotationPitch)
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_,
            ...
            float p_76986_9_)
    {
        this.doRender((EntityMissile) p_76986_1_, p_76986_2_, p_76986_4_,
