...
public class RenderTankShell extends Render
{
    ...
    private ResourceLocation texture = new ResourceLocation(
            TransformersMod.modid, "textures/models/weapons/tank_shell.png");
     ...
     */
    public void doRender(EntityTankShell tankShell, double x, double y,
            double z, float rotationYaw, float p_76986_9_)
    {
        GL11.glPushMatrix();
        GL11.glTranslatef((float) x, (float) y + 1.5F, (float) z);
        GL11.glRotatef(tankShell.prevRotationYaw
                + (tankShell.rotationYaw - tankShell.prevRotationYaw)
                * p_76986_9_ - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(tankShell.prevRotationPitch
                + (tankShell.rotationPitch - tankShell.prevRotationPitch)
    ...
    public void doRender(Entity p_76986_1_, double p_76986_2_,
            ...
            float p_76986_9_)
    {
        this.doRender((EntityTankShell) p_76986_1_, p_76986_2_, p_76986_4_,
