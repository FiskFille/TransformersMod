...
public class RenderMiniMissile extends Render
{
    ...
    private ResourceLocation texture = new ResourceLocation(
            TransformersMod.modid, "textures/models/weapons/missile.png");
     ...
     */
    public void doRender(EntityMiniMissile miniMissile, double x, double y,
            double z, float rotationYaw, float p_76986_9_)
    {
        this.bindEntityTexture(miniMissile);
        GL11.glPushMatrix();
        GL11.glTranslatef((float) x, (float) y, (float) z);
        GL11.glRotatef(miniMissile.prevRotationYaw
                + (miniMissile.rotationYaw - miniMissile.prevRotationYaw)
                * p_76986_9_ - 90.0F, 0.0F, 1.0F, 0.0F);
        GL11.glRotatef(miniMissile.prevRotationPitch
                + (miniMissile.rotationPitch - miniMissile.prevRotationPitch)
    ...
    {
        this.doRender((EntityMiniMissile) entity, x, y, z, rotationYaw,
                partialTicks);
    }
}