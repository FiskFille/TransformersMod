...
public class RenderItemRelayTower implements IItemRenderer
{
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityRelayTower(), 0.0F, 0.0F, 0.0F, 0.0F);
    }
}
