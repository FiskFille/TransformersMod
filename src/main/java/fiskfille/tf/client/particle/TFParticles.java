...
public class TFParticles
{
    ...
    public static EntityFX spawnParticle(TFParticleType particleType, double x,
            double y, double z, float motionX, float motionY, float motionZ)
    {
                ...
                && mc.effectRenderer != null)
        {
            if (theWorld.isRemote)
            {
                ...
                if (diffX * diffX + diffY * diffY + diffZ * diffZ > maxRenderDistance
                        * maxRenderDistance)
                {
                    return null;
                }
                ...
                {
                    particle = new EntityTFFlameFX(theWorld, x, y, z, motionX,
                            motionY, motionZ);
