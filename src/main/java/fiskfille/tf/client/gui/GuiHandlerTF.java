...
public class GuiHandlerTF implements IGuiHandler
{
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        switch (id)
        {
            ...
            case 3:
                return world.getBlock(x, y, z) == TFBlocks.displayStation ? new ContainerDisplayStationArmor(player.inventory, (TileEntityDisplayStation) tileEntity) : null;
        }
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z)
    {
        ...
        switch (id)
        {
            ...
            case 3:
                return world.getBlock(x, y, z) == TFBlocks.displayStation ? new GuiDisplayStationArmor(player.inventory, (TileEntityDisplayStation) tileEntity) : null;
        }
