...
//            ItemStack result = new ItemStack(TFItems.fuelCanister);
//
...
//    {
//        float percentMultiplier = 1F / recipe.liquidAmount;
...
//            	float f = (float)recipe1.liquidAmount / 2000;
//
//            	GL11.glPushMatrix();
...
//
//                    float percentMultiplier = 1F / recipe1.liquidAmount;
...
//                    }
//
//                    text.add(StatCollector.translateToLocalFormatted("gui.energon_processor.filled", recipe1.liquidAmount, 2000));
