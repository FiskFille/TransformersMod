...
import fiskfille.transformersmod.item.armor.ItemCloudtrapArmor;
import fiskfille.transformersmod.item.armor.ItemPurgeArmor;
import fiskfille.transformersmod.item.armor.ItemSkystrikeArmor;
import fiskfille.transformersmod.item.armor.ItemSubwooferArmor;
import fiskfille.transformersmod.item.armor.ItemVurpArmor;
import fiskfille.transformersmod.registry.TFItemRegistry;
